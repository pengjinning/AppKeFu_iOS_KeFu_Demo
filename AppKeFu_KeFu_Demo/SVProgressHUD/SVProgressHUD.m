...
+ (void)showRecording
{
    [[SVProgressHUD sharedView] showWithRecordingImage:[UIImage imageNamed:@"amp1"]];
}

+ (void) showRecordingWithImage:(UIImage *)image
{
    [[SVProgressHUD sharedView] showWithRecordingImage:image];
}

- (void)showWithRecordingImage:(UIImage*)image
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        self.fadeOutTimer = nil;
        self.imageView.image = image;//[UIImage imageNamed:@"amp1"];
